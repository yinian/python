...
for index, first_name in enumerate(first_name_list):
    ...
    birthday = '{}-0{}-{}'.format(this_year - age, random.randint(1, 9),
    ...
    data = {
        ...
        'name':
        '{}{}{}'.format(
            random.choice(last_name_list), '' if len(first_name) == 2 else "小",
            first_name),
        'age':
        age,
        'birthday':
